...
export const EmployeeProfilesSearchLayout = ({ config, appName }) => {
      ...
      <Grid>
        ...
        <Grid.Row className="mobile tablet only">
          ...
          <Grid.Column mobile={14} tablet={15} floated="right" className="mt-10">
            <SearchBar placeholder={i18next.t("Search Employee Profiles...")} />
          </Grid.Column>
        </Grid.Row>
...
EmployeeProfilesSearchLayout.propTypes = {
  config: PropTypes.object.isRequired,
  appName: PropTypes.string,
};

EmployeeProfilesSearchLayout.defaultProps = {
  appName: "",
};
